...
const AllStocks = () => {
  ...
  useEffect(()=>{
    (async ()=>{
      try{
        const res=await axios.get('https://stock-profile-tracker-1.onrender.com/service/stockname');
      ...
      try{
        ...
        symbols.map(async(symbol,index)=>{
          arr.push(await axios.get(
            `https://stock-profile-tracker-1.onrender.com/service/scrapweb/info?symbol=${symbol}`
          ));
        })
        arr.map((res,index)=>{
